...
- (void)testSyncResponseMessage {
    ...
    char kaatcp[] = {0x00,0x06,'K','a','a','t','c','p', 0x01, 0x00, 0x05, 0x14, 0xFF};
...
- (void)testSyncRequestMessage {
    char kaatcp[] = {0x00,0x06,'K','a','a','t','c','p', 0x01, 0x00, 0x05, 0x15, 0xFF};
    NSData *kaaSync = [NSData dataWithBytes:&kaatcp length:sizeof(kaatcp)];
...
- (void)testConnectMessage {
    ...
    char charConnectHeader[17] = {0x00, 0x06, 'K','a','a','t','c','p', 0x01, 0x02, 0xd4, 0xF2, 0x91, 0xf2, 0x00, 0x00, 0xC8};
...
- (void)testPingRequest {
    ...
    NSData *actual = [message getFrame];
    XCTAssertEqualObjects(actual, [NSData data]);
}
